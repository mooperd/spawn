...
netManagement = ipaddress.ip_network(u'10.51.103.0/29')
netProduction = ipaddress.ip_network(u'192.168.103.0/29')

filename_M = "/etc/dhcp/dhcpd.conf.10.51.103.0"
filename_P = "/etc/dhcp/dhcpd.conf.192.168.103.0"
